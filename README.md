...
- Phase 49: production integration template (`config/production.env.example`), tenant corpus materialization CLI, kind local Helm deploy (`scripts/deploy_helm_local.py`), `docs/production-integration.md`
