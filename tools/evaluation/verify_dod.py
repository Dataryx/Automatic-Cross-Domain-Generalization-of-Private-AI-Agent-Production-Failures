...
def verify() -> DodReport:
    ...
    # Sim script
    report.checks.append(DodCheck("sim_script", (ROOT / "tools" / "feasibility" / "run_cfi_sim.py").exists()))

    # Phase harnesses
    report.checks.append(DodCheck("consortium_pilot", (ROOT / "tools/evaluation" / "consortium" / "run_consortium_pilot.py").exists()))
    report.checks.append(DodCheck("field_pilot", (ROOT / "tools/evaluation" / "field" / "run_prospective_pilot.py").exists()))
    report.checks.append(DodCheck("corpus_benchmark", (ROOT / "tools/evaluation" / "benchmarks" / "run_corpus.py").exists()))
    report.checks.append(DodCheck("review_ui_route", True, "GET /review/ui on registry"))
    report.checks.append(DodCheck("golden_path_script", (ROOT / "scripts" / "ops" / "golden_path.py").exists()))
    report.checks.append(DodCheck("tau_adapter", (ROOT / "tools/evaluation" / "benchmarks" / "tau_adapter.py").exists()))
    ...
    report.checks.append(DodCheck("materialize_tenant_corpus_script", (ROOT / "scripts" / "ops" / "materialize_tenant_corpus.py").exists()))
    report.checks.append(DodCheck("deploy_helm_local_script", (ROOT / "scripts" / "ops" / "deploy_helm_local.py").exists()))
    report.checks.append(DodCheck("tenant_corpus_data", (ROOT / "tools/evaluation" / "benchmarks" / "corpus" / "tenants").exists()))
    report.checks.append(DodCheck("health_check_script", (ROOT / "scripts" / "ops" / "health_check.py").exists()))
    ...
    report.checks.append(DodCheck("live_replay_smoke", (ROOT / "scripts" / "ops" / "live_replay_smoke.py").exists()))
    report.checks.append(DodCheck("verify_figures_script", (ROOT / "scripts" / "ci" / "verify_figures.py").exists()))
    report.checks.append(DodCheck("verify_field_study_script", (ROOT / "scripts" / "ci" / "verify_field_study.py").exists()))
    ...
    report.checks.append(DodCheck("incident_bundle_corpus", (ROOT / "tools/evaluation" / "benchmarks" / "corpus" / "bundles").exists()))
    report.checks.append(DodCheck("observability_module", (ROOT / "packages" / "cfi_core" / "src" / "cfi_core" / "observability.py").exists()))
    report.checks.append(DodCheck("verify_observability_script", (ROOT / "scripts" / "ci" / "verify_observability.py").exists()))
    report.checks.append(DodCheck("middleware_module", (ROOT / "packages" / "cfi_core" / "src" / "cfi_core" / "middleware.py").exists()))
    report.checks.append(DodCheck("verify_production_hardening", (ROOT / "scripts" / "ci" / "verify_production_hardening.py").exists()))
    ...
    report.checks.append(DodCheck("verify_auth_script", (ROOT / "scripts" / "ci" / "verify_auth.py").exists()))
    ...
    report.checks.append(DodCheck("package_release_script", (ROOT / "scripts" / "ops" / "package_release.py").exists()))
    ...
    report.checks.append(DodCheck("verify_release_script", (ROOT / "scripts" / "ci" / "verify_release.py").exists()))
    report.checks.append(DodCheck("generate_release_signing_key", (ROOT / "scripts" / "ops" / "generate_release_signing_key.py").exists()))
    report.checks.append(DodCheck("verify_replay_profiles_script", (ROOT / "scripts" / "ci" / "verify_replay_profiles.py").exists()))
    report.checks.append(DodCheck("agentrx_stub_service", (ROOT / "services" / "integrations" / "agentrx" / "main.py").exists()))
    report.checks.append(DodCheck("causalflow_stub_service", (ROOT / "services" / "integrations" / "causalflow" / "main.py").exists()))
    ...
    report.checks.append(DodCheck("verify_eval_harnesses_script", (ROOT / "scripts" / "ci" / "verify_eval_harnesses.py").exists()))
    report.checks.append(DodCheck("verify_compose_stack_script", (ROOT / "scripts" / "ci" / "verify_compose_stack.py").exists()))
    ...
    report.checks.append(DodCheck("verify_audit_attestation_script", (ROOT / "scripts" / "ci" / "verify_audit_attestation.py").exists()))
    ...
    report.checks.append(DodCheck("verify_helm_chart_script", (ROOT / "scripts" / "ci" / "verify_helm_chart.py").exists()))
    report.checks.append(DodCheck("verify_helm_deploy_script", (ROOT / "scripts" / "ci" / "verify_helm_deploy.py").exists()))
    report.checks.append(DodCheck("verify_live_hooks_script", (ROOT / "scripts" / "ci" / "verify_live_hooks.py").exists()))
    report.checks.append(DodCheck("verify_corpus_batch_script", (ROOT / "scripts" / "ci" / "verify_corpus_batch.py").exists()))
    report.checks.append(DodCheck("corpus_tenants_module", (ROOT / "tools/evaluation" / "corpus_tenants.py").exists()))
    ...
    report.checks.append(DodCheck("verify_remote_registry_cli_script", (ROOT / "scripts" / "ci" / "verify_remote_registry_cli.py").exists()))
    report.checks.append(DodCheck("tau_live_module", (ROOT / "tools/evaluation" / "benchmarks" / "tau_live.py").exists()))
    report.checks.append(DodCheck("tau_stub_service", (ROOT / "services" / "integrations" / "tau" / "main.py").exists()))
    report.checks.append(DodCheck("verify_tau_live_script", (ROOT / "scripts" / "ci" / "verify_tau_live.py").exists()))
    report.checks.append(DodCheck("verify_contribute_publish_script", (ROOT / "scripts" / "ci" / "verify_contribute_publish.py").exists()))
    report.checks.append(DodCheck("agent_hooks_module", (ROOT / "packages" / "cfi_contributor" / "src" / "cfi_contributor" / "agent_hooks.py").exists()))
    report.checks.append(DodCheck("verify_agent_hooks_script", (ROOT / "scripts" / "ci" / "verify_agent_hooks.py").exists()))
    report.checks.append(DodCheck("verify_cross_boundary_script", (ROOT / "scripts" / "ci" / "verify_cross_boundary.py").exists()))
    ...
    report.checks.append(DodCheck("verify_corpus_publish_script", (ROOT / "scripts" / "ci" / "verify_corpus_publish.py").exists()))
    report.checks.append(DodCheck("recipient_assess_module", (ROOT / "packages" / "cfi_recipient" / "src" / "cfi_recipient" / "assess.py").exists()))
    report.checks.append(DodCheck("verify_end_to_end_script", (ROOT / "scripts" / "ci" / "verify_end_to_end.py").exists()))
    ...
    report.checks.append(DodCheck("verify_federation_workflow_script", (ROOT / "scripts" / "ci" / "verify_federation_workflow.py").exists()))
    ...
    report.checks.append(DodCheck("verify_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_compose_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_compose_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_postgres_compose_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_postgres_compose_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_tls_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_tls_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_mtls_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_mtls_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_cli_endpoints_script", (ROOT / "scripts" / "ci" / "verify_cli_endpoints.py").exists()))
    ...
    report.checks.append(DodCheck("pipeline_matrix_module", (ROOT / "tools/evaluation" / "pipeline_matrix.py").exists()))
    report.checks.append(DodCheck("verify_pipeline_matrix_script", (ROOT / "scripts" / "ci" / "verify_pipeline_matrix.py").exists()))
    report.checks.append(DodCheck("verify_pipeline_matrix_ci_script", (ROOT / "scripts" / "ci" / "verify_pipeline_matrix_ci.py").exists()))
    ...
    report.checks.append(DodCheck("verify_postgres_tls_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_postgres_tls_full_pipeline.py").exists()))
    report.checks.append(DodCheck("verify_mtls_required_full_pipeline_script", (ROOT / "scripts" / "ci" / "verify_mtls_required_full_pipeline.py").exists()))
    report.checks.append(DodCheck("http_tls_module", (ROOT / "packages" / "cfi_core" / "src" / "cfi_core" / "http_tls.py").exists()))
    report.checks.append(DodCheck("pipeline_smoke_module", (ROOT / "tools/evaluation" / "pipeline_smoke.py").exists()))
    ...
    report.checks.append(DodCheck("verify_postgres_compose_script", (ROOT / "scripts" / "ci" / "verify_postgres_compose.py").exists()))
    ...
    report.checks.append(
        DodCheck(
            ...
            and "tools/evaluation/run_all.py" in (ROOT / ".github" / "workflows" / "ci.yml").read_text(),
        )
    )
    report.checks.append(
        DodCheck(
    ...
    try:
        ...
        bundle_path = ROOT / "tools/evaluation" / "benchmarks" / "corpus" / "bundles" / "bench-001.json"
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_replay_profiles.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_eval_harnesses.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_audit_attestation.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_helm_chart.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_corpus_batch.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
            timeout=180,
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_helm_deploy.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
            timeout=180,
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_live_hooks.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
            timeout=300,
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_remote_registry_cli.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_tau_live.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_contribute_publish.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_agent_hooks.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_cross_boundary.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_corpus_publish.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_end_to_end.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_federation_workflow.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_full_pipeline.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_cli_endpoints.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
    ...
    try:
        result = subprocess.run(
            [sys.executable, "scripts/ci/verify_pipeline_matrix.py"],
            cwd=ROOT,
            capture_output=True,
            text=True,
        )
